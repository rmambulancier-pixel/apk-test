const CACHE = 'mesheures-shell-v16.1.0';
const SHELL = ['./', './index.html', './manifest.json', './icon.svg', './style/refonte.css?v=16.1.0', './scripts/app-core.js', './scripts/app-pwa.js', './scripts/app-ui.js', './scripts/app-parser.js', './scripts/app-plugins.js', './scripts/app.js'];
