const CACHE = 'mesheures-shell-v18.0.9';
const SHELL = ['./', './index.html', './manifest.json', './icon.svg', './style/refonte.css?v=18.0.9', './scripts/app-core.js', './scripts/app-pwa.js', './scripts/app-ui.js', './scripts/app-parser.js', './scripts/app-plugins.js', './scripts/app.js', './scripts/app-projection.js', './scripts/app-legal.js', './scripts/app-backup.js', './scripts/app-v17.js', './scripts/app-intelligence.js', './scripts/app-evidence.js', './scripts/app-dossier.js', './scripts/app-reconciliation.js', './scripts/pay-fix-v16.2.js'];
