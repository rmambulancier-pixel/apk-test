...
## V18.0.10 — Integrity correction / Lot 8
...
# MesHeures V18.0.10 — Android + PWA
...
> **Version actuelle : V18.0.10 — versionCode Android 1810**
>
...
## V18.0.10 — maintenance thème, performances et régression
...
- Version synchronisée : Android `18.0.10` / `versionCode 1810`, PWA, Service Worker, manifest et interface.

## V18.0.10 — correctif interface, Jour et impression
...
- Version synchronisée : Android `18.0.10` / `versionCode 1810`, PWA, Service Worker et interface.
