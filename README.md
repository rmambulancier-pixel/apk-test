...
## V18.0.11 — Integrity correction / Lot 8
...
# MesHeures V18.0.11 — Android + PWA
...
> **Version actuelle : V18.0.11 — versionCode Android 1811**
>
...
## V18.0.11 — maintenance thème, performances et régression
...
- Version synchronisée : Android `18.0.11` / `versionCode 1811`, PWA, Service Worker, manifest et interface.

## V18.0.11 — correctif interface, Jour et impression
...
- Version synchronisée : Android `18.0.11` / `versionCode 1811`, PWA, Service Worker et interface.
...
## V18.0.11 — Correctif thème clair complet
...
- Version Android 18.0.11 / versionCode 1811, PWA, manifest, Service Worker et workflow synchronisés.
